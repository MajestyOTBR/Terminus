...
-- server url
url = "https://github.com/Nottinghster/Solidus/"

-- server owner name
ownername = "Nottinghster & Tryller"

-- server owner email
owneremail = "nottinghster92@gmail.com"
...
-- How many unjustified kills player need to be banished (Default: 20 -> double of kills per month)
kills_to_ban = 20
...
--[[ Added by Nottinghster - 7.8x features ]]--
...
hunting_kill_duration = unjust_skull_duration